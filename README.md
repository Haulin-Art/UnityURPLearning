...
| Shader | 用途 |
|--------|------|
| S_Actor_Body | 角色身体（支持皮肤/非皮肤模式） |
| S_Actor_Hair | 角色头发（透明排序、Stencil 遮挡） |
| S_Actor_Face | 角色面部 |
| S_Actor_Brow | 角色眉毛 |
| S_Actor_Iris | 角色眼睛/虹膜 |
| S_Actor_Cloth | 角色衣物 |
| S_Actor_Shadow_Hair2Face | 头发投射到面部的阴影 |
| S_Actor_Shadow_Eye | 眼睛阴影 |
...
| 通道 | 适用场景 | 计算方法 |
|------|----------|----------|
| **diffR 宏观体积散射** | 深水区域 | G_entry × T_entry × S_volume |
